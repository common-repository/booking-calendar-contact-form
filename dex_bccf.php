...
if (isset($wpdb->prefix))
    ...
    define('DEX_BCCF_CALENDARS_TABLE_NAME', "bccf_reservation_calendars_data");
...
if (isset($wpdb->prefix))
    ...
    define('DEX_BCCF_CONFIG_TABLE_NAME', "bccf_reservation_calendars");
...
if (isset($wpdb->prefix))
    ...
    define('DEX_BCCF_DISCOUNT_CODES_TABLE_NAME', "bccf_dex_discount_codes");
...
function _dex_bccf_install() {
    ...
    $results = $wpdb->get_results("SHOW TABLES LIKE '".$wpdb->prefix.DEX_BCCF_DISCOUNT_CODES_TABLE_NAME_NO_PREFIX."'"); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
    if (!count($results)) {
    ...
    $results = $wpdb->get_results("SHOW TABLES LIKE '".$wpdb->prefix.DEX_BCCF_SEASON_PRICES_TABLE_NAME_NO_PREFIX."'"); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
    if (!count($results)) {
    ...
    $results = $wpdb->get_results("SHOW TABLES LIKE '".$wpdb->prefix.DEX_BCCF_TABLE_NAME_NO_PREFIX."'"); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
    if (!count($results)) {
    ...
    $results = $wpdb->get_results("SHOW TABLES LIKE '".$wpdb->prefix.DEX_BCCF_CONFIG_TABLE_NAME."'"); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
    if (!count($results)) {
    ...
    $results = $wpdb->get_var("SELECT count(id) FROM ".$wpdb->prefix.DEX_BCCF_CONFIG_TABLE_NAME.""); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
    if (!$results)
    {
    ...
    $results = $wpdb->get_results("SHOW TABLES LIKE '".$wpdb->prefix.DEX_BCCF_CALENDARS_TABLE_NAME_NO_PREFIX."'"); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
    if (!count($results)) {
        $sql = "CREATE TABLE `".$wpdb->prefix.DEX_BCCF_CALENDARS_TABLE_NAME_NO_PREFIX."` (".
